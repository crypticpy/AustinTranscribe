...
export function StrategySelector({
  ...
  const strategyOptions = [
    ...
    { value: "basic", label: "⚡ Basic - Fast (30-60s)" },
    { value: "hybrid", label: "🔄 Hybrid - Balanced (2-3min)" },
    { value: "advanced", label: "🎯 Advanced - Deep (4-5min)" },
  ];
      ...
      <Stack gap="sm">
        <Group align="flex-start" gap="md" wrap="wrap">
          ...
          <Checkbox
            ...
            description="Review and improve results (+35-45s)"
              ...
              <Stack gap="md">
                ...
                <Box>
                  ...
                  <Text size="sm" c="dimmed">
                    Review and improve the analysis with a quality-check pass. Adds 30-45 seconds but
      ...
      <Stack gap="lg">
        ...
        <Alert icon={<Info size={16} />} color="gray" variant="light">
          <Text size="xs" c="dimmed">
            All strategies produce high-quality results. Choose based on your time constraints and
            meeting complexity. The auto-select option is recommended for most users.
          </Text>
        </Alert>
      </Stack>
    </Paper>
