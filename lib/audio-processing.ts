...
/**
 * Maximum audio duration for Whisper API (1500 seconds / 25 minutes)
 * Lowered to 1200 (20 minutes) to safely accommodate GPT-4o Audio chunk limits (~1400s).
 */
export const MAX_WHISPER_DURATION = 1200;
...
/**
 * File size threshold for triggering conversion (5MB)
 */
